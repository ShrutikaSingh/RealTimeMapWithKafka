...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
  ...
  maxZoom: 18,
  id: 'mapbox/streets-v11', // Updated to match the new Mapbox style ID format
  accessToken: MAP_ACCESS_TOKEN // ENTER YOUR ACCESS TOKEN HERE
}).addTo(mymap);

mapMarkers1 = [];
mapMarkers2 = [];
mapMarkers3 = [];
//https://api.mapbox.com/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}?MAP_ACCESS_TOKEN
